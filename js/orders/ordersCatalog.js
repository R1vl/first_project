  ...
  if (counterValue > 0) {
    ...
    if (window.innerWidth > 576) {
      ...
      if (!mobileNav.hasAttribute(".mobile-nav_list--open")) {
        ...
        firstLine.classList.add("nav-opener_line--first-animation");
        secondLine.classList.add("nav-opener_line--first-animation");
        thirdLine.classList.add("nav-opener_line--second-animation");
      }
    }
  }
}
